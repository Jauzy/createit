                ...
                <div className='container py-5'>
                    <div className='d-flex flex-wrap'>
                        <div className='mr-auto my-auto'>
                            {state.activeSection == 'Design' && <h1>Desain Anda</h1>}
                            {state.activeSection == 'Design' && <h6>untuk kontes Projek X</h6>}
                            {state.activeSection != 'Design' && <h1>Project X</h1>}
                            {state.activeSection != 'Design' && <h6>oleh Weeb Developer | <NumberFormat value={500000} displayType={'text'} thousandSeparator={true} prefix={'IDR. '} /></h6>}
                        </div>
