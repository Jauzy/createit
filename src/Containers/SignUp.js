            ...
            <div className='col-md d-flex'>
                <div className='m-auto'>
                    ...
                    <div className='row mt-4'>
                        <div className='col-md d-flex'>
                            <button className='btn-main btn-block btn m-auto px-4 py-3 d-flex align-items-center justify-content-center' disabled={!state.email || !state.password || !state.name}
                                onClick={onSubmit}>
