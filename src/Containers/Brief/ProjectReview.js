...
const ProjectReview = (props) => {
    ...
    const [state, setState] = useState({
        category: 'Kemasan dan Label', subcategory: 'Kemasan Botol', duration: '48 Jam', budget: 1231234,
        ...
        <div className=''>
            ...
            <div className='container py-5'>
                <div className='d-flex flex-wrap pb-3'>
                    <button className='btn btn-main px-5 py-3 m-2' onClick={() => props.history.replace('/brief/project')}>Edit</button>
