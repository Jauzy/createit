...
const ListCard = props => {
    const { item } = props
    return (
        <Link className='text-decoration-none text-dark' to={`/contest/dashboard/${item._id}`}>
            <div className='row contest-card rounded-lg'>
                <div className='col-md-auto'>
                    <img width='100%' className='rounded-lg bg-light' src={require('../../Modules/images/27033.jpg')} style={{ width: '200px', height: '200px', objectFit: 'cover' }} />
